        ...
        <div class="row">
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-left justify-content-left">
                    ...
                    <li class="breadcrumb-item"><a href="Produit?id=${cat.getId() }>">${cat.getTitre()}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">${cproduit.getTitre()}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="product-sync-init mb-20">
                    <div class="single-product">
                        <div class="">
                            <img src="${cproduit.getImg() }"  alt="product-thumb">
                        </div>
                    </div>
                    <!-- single-product end -->
                ...
                <div class="single-product-info">
                    ...
                    <div class="product-body mb-40">
                        <div class="d-flex align-items-center mb-30">
                            ...
                            <span class="badge position-static bg-dark rounded-0">Economisez 10%</span>
                        </div>
                        <p>${cproduit.getDescriptionsm()}</p>
                    ...
                    <div class="product-footer">
                        <div class="product-count style d-flex flex-column flex-sm-row mt-30 mb-30">
                            <div class="count d-flex">
                                ...
                                <input name="pqte" type="number" min="1" max="10" value="1">
                            </div>
                            <div>
                                <button name="badd" class="btn theme-btn--dark3 btn--xl mt-5 mt-sm-0 rounded-5">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="single-product-desc">
                            ...
                            <div class="product-features">
                                <ul>
                                    <div class="col-3"><li ><span >Thèmes & Mécanismes</span></li></div>
