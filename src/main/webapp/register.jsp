...
<body>
			...
			<div class="row">
				...
				<div class="col-12">
					<ol
						...
						<li class="breadcrumb-item active" aria-current="page">Nouveau
							compte</li>
					</ol>
				</div>
			</div>
	...
	<div class="register pt-80 pb-80">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h3 class="title text-capitalize mb-30 pb-25">Créer un compte</h3>
					<%
					if ((boolean) request.getAttribute("messagemailno") == true) {
					%>
					<div class="alert alert-danger" role="alert">Adresse mail
						déjà enregistrée</div>
					<%}%>
					<%
					if ((boolean) request.getAttribute("messageinscriptionok") == true) {
					%>
					<div class="alert alert-success" role="alert">Inscription éffectuée. Connectez-vous à votre compte</div>
					<%}%>
					<div class="log-in-form">
						<form method="POST" class="personal-information">
							<div class="order-asguest theme1 mb-3">
								<span>Déjà un compte ?</span> <a class="text-muted hover-color"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<div class="d-flex flex-wrap">
										<div required class="custom-radio">
											<input required value="M" name="gender" type="radio" id="test1" name="radio-group">
											<label for="test1">Mr</label>
										</div>
										<div class="custom-radio">
											<input value="F" name="gender" type="radio" id="test2" name="radio-group">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input required name="prenom" type="text" id="firstname"
										class="form-control">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input required name="nom" type="text" id="lastname"
										class="form-control">
								</div>
							</div>
							<div class="form-group row">
								<label for="lastname" class="col-md-3 col-form-label">Numero
									de téléphone</label>
								<div class="col-md-6">
									<input required name="tel" type="tel" id="tel" class="form-control">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label for="Password" class="col-md-3 col-form-label">Mot
									de passe</label>
								<div class="col-md-6">
							...
							<div class="form-group row">
								...
								<div class="col-12">
									<div class="sign-btn text-right">
										...
										<button type="submit" name="bsave"
											class="btn theme-btn--dark3 btn--md">Enregistrer</button>
									</div>
								</div>
							</div>
						</form>
