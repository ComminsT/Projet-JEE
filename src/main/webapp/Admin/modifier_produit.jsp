...
<body>
<%Produit cproduit = (Produit)request.getAttribute("cproduit"); %>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="card-box">
								<h4 class="header-title">Modifier le produit :
									${cproduit.getTitre() }</h4>
								<%
								if ((boolean) request.getAttribute("messageok") == true) {
								%>
								<div class="alert alert-success" role="alert">la
									modification est effectuée</div>
								<%
								}
								%>
								...
								<form method="POST" class="parsley-examples">
									<div class="form-group">
										Titre <input type="text" name="titre"
											value="${cproduit.getTitre() }" placeholder="Titre"
											parsley-trigger="change" required class="form-control">
									</div>

									<div class="form-group">
										Prix <input type="text" name="prix"
											value="${cproduit.getPrix() }" placeholder="Prix"
											parsley-trigger="change" required class="form-control">
									</div>
									<div class="form-group">
										Quantité <input type="text" name="qte"
											value="${cproduit.getQuantite() }" placeholder="Quantité"
											parsley-trigger="change" required class="form-control">
									</div>
									<div class="form-group">
										Image <input type="text" name="image"
											value="${cproduit.getImg() }" placeholder="Image"
											parsley-trigger="change" required class="form-control">
									</div>
									<div class="form-group">
										Nombre de joueurs minimum <input type="number" name="jmin"
											value="${cproduit.getNbrjoueurmin() }"
											placeholder="Nombre de joueurs minimum"
											parsley-trigger="change" required class="form-control">
									</div>
									<div class="form-group">
										Nombre de joueurs maximum <input type="number" name="jmax"
											value="${cproduit.getNbrjoueurmax() }"
											placeholder="Nombre de joueurs maximum"
											parsley-trigger="change" required class="form-control">
									</div>
									<div class="form-group">
										Age minimum <input type="number" name="amin"
											value="${cproduit.getAge() }" placeholder="Age minimum"
											parsley-trigger="change" required class="form-control">
									</div>
									...
									<div class="form-group align-self-start">
										Visible <input type="Checkbox" name="visible"
											value=""
											parsley-trigger="change"<%if(cproduit.getVisible()==true){ %>checked<%}%>>
									</div>
									tags
									...
									<div class="form-group">
										...
										<textarea rows="10" name="description"
											placeholder="Description compléte" parsley-trigger="change"
											required class="form-control">${cproduit.getDescription() }</textarea>
									</div>
									<div class="form-group">
										Description courte
										<textarea rows="5" name="descriptionm"
											placeholder="Description courte" parsley-trigger="change"
											required class="form-control">${cproduit.getDescriptionsm() }</textarea>
									</div>
									...
									<div class="form-group">
										<select name="categorie_id" id="categorie_id"
											...
											%>
											<option value="<%=cat.getId()%>"><%=cat.getTitre()%></option>
											<%
											}
											%>
										</select>
									...
									<div class="form-group text-right mb-0">
										<button class="btn btn-primary waves-effect waves-light mr-1"
											name="bmodifier" type="submit">Modifier</button>
