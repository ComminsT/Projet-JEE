                        ...
                        <ul class="metismenu" id="side-menu">
							...
							<li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="Ajouter_produit">Ajouter un produit</a>
                                    </li>
                                    <li>
                                        <a href="Liste_produits">Liste de produit</a>
                                    </li>
							...
							<li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="ajouter_utilisateur.html">Ajouter un utilisateur</a>
                                    </li>
                                    <li>
                                        <a href="utilisateur_list.html">Liste d'utilisateurs</a>
                                    </li>
