                                   ...
                                   <% if((boolean)request.getAttribute("messageok")==true){ %>
                                    ...
                                    <form method="POST" class="parsley-examples">
                                        <div class="form-group">
                                            <input type="text" name="titre" placeholder="Titre" parsley-trigger="change" required  class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" name="prix" placeholder="Prix" parsley-trigger="change" required  class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="qte" placeholder="Quantité" parsley-trigger="change" required  class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="image" placeholder="Image" parsley-trigger="change" required  class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <select name="categorie_id" parsley-trigger="change" required  class="form-control">
                                            	<% 
                                        ...
                                        <div class="form-group text-right mb-0">
                                            <button name="bajouter" type="submit" class="btn btn-primary waves-effect waves-light mr-1" >
                                                Ajouter
                                            </button>
